...
-- NOTE: break_minutes is kept for compatibility with the existing table,
-- but the current app intentionally ignores it because WorkTrack calculates
-- worked hours directly from check-in to check-out.
